  ...
  return (
    <>
      ...
      <Modal
        ...
        footer={
          ac!== "View" && [
            <Button  type="primary" onClick={handleOk} loading={confirmLoading}>Ok</Button>
          ]
        }
      >
        {(ac === "Create" || ac === "Update") && (
              ...
              <div className="form__teacher--item">
                ...
                >
                  <Select
                    ...
                    options={
                      test.type === "GRAMMAR" || test.type === "VOCABULARY"
                        ? [
                            {
                              value: "TRUE_FALSE",
...
export default ListExercisesTest;
